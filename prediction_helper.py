...
model_rest = joblib.load(r"C:\Users\arpan.000\My project\1800 Tut\Projects\artifacts\model_rest.joblib")
model_young = joblib.load(r"C:\Users\arpan.000\My project\1800 Tut\Projects\artifacts\model_young.joblib")

scaler_rest = joblib.load(r"C:\Users\arpan.000\My project\1800 Tut\Projects\artifacts\scaler_rest.joblib")
scaler_young = joblib.load(r"C:\Users\arpan.000\My project\1800 Tut\Projects\artifacts\scaler_young.joblib")
...
def handle_scaling(age, df):
    if 'income_level' not in df.columns:
        df['income_level'] = 0.0  # Dummy for scaler compatibility
    ...
    return df  # Don't drop anything here
